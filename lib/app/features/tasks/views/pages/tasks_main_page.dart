...
class _TasksMainPageState extends State<TasksMainPage> {
  ...
  final List<Widget> _pages = [
    ...
    const Placeholder(), // Analytics - TODO: Create TasksAnalyticsPage
  ];
              ...
              children: [
                ...
                _buildDrawerSection('GESTION', [
                  _buildDrawerActionItem(
                    icon: Icons.category,
                    title: 'Catégories',
                    onTap: () => Get.toNamed('/tasks/categories'),
                  ),
                  _buildDrawerActionItem(
                    icon: Icons.label,
                    title: 'Tags',
                    onTap: () => _showComingSoon('Tags'),
                  ),
                  _buildDrawerActionItem(
                    icon: Icons.repeat,
                    title: 'Tâches Récurrentes',
                    onTap: () => _showComingSoon('Tâches Récurrentes'),
                  ),
                ]),
                const Divider(),
